...
class FinalizeOrderProduct : NSObject, NSCoding, Mappable{

	var availableForPickup : Bool?
	var code : String?
	var name : String?
	var purchasable : Bool?
	var stock : FinalizeOrderStock?
	var url : String?


	class func newInstance(map: Map) -> Mappable?{
		return FinalizeOrderProduct()
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         stock = aDecoder.decodeObject(forKey: "stock") as? FinalizeOrderStock
