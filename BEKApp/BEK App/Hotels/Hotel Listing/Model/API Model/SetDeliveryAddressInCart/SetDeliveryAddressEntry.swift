...
class SetDeliveryAddressEntry : NSObject, NSCoding, Mappable{

	var configurationInfos : [AnyObject]?
	var entryNumber : Int?
	var product : SetDeliveryAddressProduct?
	var quantity : Int?
	var totalPrice : SetDeliveryAddressTotalPrice?


	class func newInstance(map: Map) -> Mappable?{
		return SetDeliveryAddressEntry()
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         product = aDecoder.decodeObject(forKey: "product") as? SetDeliveryAddressProduct
