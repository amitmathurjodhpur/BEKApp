//
//	GetProductListSearchFacet.swift
//
...
class GetProductListSearchFacet : NSObject, NSCoding, Mappable{

	var category : Bool?
	var multiSelect : Bool?
	var name : String?
	var priority : Int?
	var topValues : [GetProductListSearchTopValue]?
	var values : [GetProductListSearchTopValue]?
	var visible : Bool?


	class func newInstance(map: Map) -> Mappable?{
		return GetProductListSearchFacet()
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         topValues = aDecoder.decodeObject(forKey: "topValues") as? [GetProductListSearchTopValue]
         values = aDecoder.decodeObject(forKey: "values") as? [GetProductListSearchTopValue]
