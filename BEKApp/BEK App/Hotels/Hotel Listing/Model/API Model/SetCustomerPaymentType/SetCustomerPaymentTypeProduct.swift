//
//	SetCustomerPaymentTypeProduct.swift
//
...
class SetCustomerPaymentTypeProduct : NSObject, NSCoding, Mappable{

	var availableForPickup : Bool?
	var code : String?
	var name : String?
	var purchasable : Bool?
	var stock : SetCustomerPaymentTypeStock?
	var url : String?


	class func newInstance(map: Map) -> Mappable?{
		return SetCustomerPaymentTypeProduct()
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         stock = aDecoder.decodeObject(forKey: "stock") as? SetCustomerPaymentTypeStock
