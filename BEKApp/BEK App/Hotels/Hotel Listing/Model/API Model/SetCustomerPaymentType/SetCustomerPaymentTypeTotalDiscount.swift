//
//	SetCustomerPaymentTypeTotalDiscount.swift
//
...
class SetCustomerPaymentTypeTotalDiscount : NSObject, NSCoding, Mappable{
	...
	class func newInstance(map: Map) -> Mappable?{
		return SetCustomerPaymentTypeTotalDiscount()
	}
