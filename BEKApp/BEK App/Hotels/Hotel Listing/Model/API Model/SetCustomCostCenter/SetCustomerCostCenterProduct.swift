//
//	SetCustomerCostCenterProduct.swift
//
...
class SetCustomerCostCenterProduct : NSObject, NSCoding, Mappable{

	var availableForPickup : Bool?
	var code : String?
	var name : String?
	var purchasable : Bool?
	var stock : SetCustomerCostCenterStock?
	var url : String?


	class func newInstance(map: Map) -> Mappable?{
		return SetCustomerCostCenterProduct()
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         stock = aDecoder.decodeObject(forKey: "stock") as? SetCustomerCostCenterStock
