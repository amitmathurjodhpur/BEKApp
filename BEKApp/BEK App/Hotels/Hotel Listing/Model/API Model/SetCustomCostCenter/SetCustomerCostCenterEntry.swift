//
//	SetCustomerCostCenterEntry.swift
//
...
class SetCustomerCostCenterEntry : NSObject, NSCoding, Mappable{

	var configurationInfos : [AnyObject]?
	var entryNumber : Int?
	var product : SetCustomerCostCenterProduct?
	var quantity : Int?
	var totalPrice : SetCustomerCostCenterTotalPrice?


	class func newInstance(map: Map) -> Mappable?{
		return SetCustomerCostCenterEntry()
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         product = aDecoder.decodeObject(forKey: "product") as? SetCustomerCostCenterProduct
