...
class AddProductToCartProduct : NSObject, NSCoding, Mappable{

	var availableForPickup : Bool?
	var code : String?
	var name : String?
	var purchasable : Bool?
	var stock : AddProductToCartStock?
	var url : String?


	class func newInstance(map: Map) -> Mappable?{
		return AddProductToCartProduct()
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         stock = aDecoder.decodeObject(forKey: "stock") as? AddProductToCartStock
